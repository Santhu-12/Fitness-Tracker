        ...
        {goals.length > 0 ? (
          goals.map((goal) => (
            ...
            >
              ...
              <p className="text-gray-600">Goal Value: {goal.goalValue}</p>
              <p className="text-gray-600">Date Set: {goal.dateSet}</p>
          ...
          <p className="text-center text-gray-600">No goals set yet.</p>
        )}
      </div>
    </div>
  );
