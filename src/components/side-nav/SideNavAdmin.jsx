...
function SideNavAdmin() {
  return (
    <aside
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 translate-x-0 bg-black`}
    >
      <div className="flex items-center justify-between gap-2 px-6 pt-6 lg:py-6.5">
        <h1 className="mb-4 ml-4 text-lg font-semibold text-bodydark2">
          <Logo />
        </h1>
      </div>
